...
public static class RePoeImportDiagnosticCodes
{
    ...
    public const string ItemClassRecordMissingId = "REPOE_ITEM_CLASS_RECORD_MISSING_ID";
    public const string ItemClassRecordMalformed = "REPOE_ITEM_CLASS_RECORD_MALFORMED";
    ...
    public const string ModsByBaseStatlessModifierUnavailable = "REPOE_MODS_BY_BASE_STATELESS_MODIFIER_UNAVAILABLE";
    public const string ModsByBaseOtherModifierUnavailable = "REPOE_MODS_BY_BASE_OTHER_MODIFIER_UNAVAILABLE";
    public const string ModsByBaseUnknownModifier = "REPOE_MODS_BY_BASE_UNKNOWN_MODIFIER";
    public const string ModsByBaseDuplicateRelationship = "REPOE_MODS_BY_BASE_DUPLICATE_RELATIONSHIP";
    public const string ModsByBaseDuplicateBase = "REPOE_MODS_BY_BASE_DUPLICATE_BASE";
    public const string ModsByBaseConditionalModifierUnknown = "REPOE_MODS_BY_BASE_CONDITIONAL_MODIFIER_UNKNOWN";
    public const string ModsByBaseSpecialEntryNotModeled = "REPOE_MODS_BY_BASE_SPECIAL_ENTRY_NOT_MODELED";
    ...
    public const string PoBUniqueFileNotFound = "POB_UNIQUE_FILE_NOT_FOUND";
