...
public static class ModifierCandidateResolutionDiagnosticCodes
{
    ...
    public const string ModifierTextExactMatch = "MODIFIER_TEXT_EXACT_MATCH";
    public const string ModifierTextExactEquivalentSourceSet = "MODIFIER_TEXT_EXACT_EQUIVALENT_SOURCE_SET";
