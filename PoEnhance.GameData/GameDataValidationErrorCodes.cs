...
public static class GameDataValidationErrorCodes
{
    ...
    public const string ItemClassIdDuplicate = "itemClass.id.duplicate";
    public const string ItemClassInfluenceTagUnknown = "itemClass.influenceTag.unknown";
    public const string ItemClassSourcesRequired = "itemClass.sources.required";
    public const string TagRequired = "tag.required";
    public const string TagIdRequired = "tag.id.required";
    public const string TagIdDuplicate = "tag.id.duplicate";
    public const string TagSourcesRequired = "tag.sources.required";
    public const string ItemBaseItemClassUnknown = "itemBase.itemClass.unknown";
    public const string ItemBaseTagUnknown = "itemBase.tag.unknown";
    public const string ModifierTagUnknown = "modifier.tag.unknown";
    public const string ModifierSpawnWeightTagUnknown = "modifier.spawnWeight.tag.unknown";
    public const string BaseModifierEvidenceSemanticsInvalid = "baseModifierEvidence.semantics.invalid";
    public const string BaseModifierEvidenceCoverageInvalid = "baseModifierEvidence.coverage.invalid";
    public const string BaseModifierEvidenceCountInvalid = "baseModifierEvidence.count.invalid";
    public const string BaseModifierEvidenceCountContradiction = "baseModifierEvidence.count.contradiction";
    public const string BaseModifierEvidenceSourcesRequired = "baseModifierEvidence.sources.required";
    public const string BaseModifierEvidenceGroupRequired = "baseModifierEvidence.group.required";
    public const string BaseModifierEvidenceGroupBasesRequired = "baseModifierEvidence.group.bases.required";
    public const string BaseModifierEvidenceGroupModifiersRequired = "baseModifierEvidence.group.modifiers.required";
    public const string BaseModifierEvidenceGroupSourcesRequired = "baseModifierEvidence.group.sources.required";
    public const string BaseModifierEvidenceBaseIdRequired = "baseModifierEvidence.baseId.required";
    public const string BaseModifierEvidenceBaseIdUnknown = "baseModifierEvidence.baseId.unknown";
    public const string BaseModifierEvidenceBaseIdDuplicate = "baseModifierEvidence.baseId.duplicate";
    public const string BaseModifierEvidenceModifierRequired = "baseModifierEvidence.modifier.required";
    public const string BaseModifierEvidenceModifierIdRequired = "baseModifierEvidence.modifierId.required";
    public const string BaseModifierEvidenceModifierIdUnknown = "baseModifierEvidence.modifierId.unknown";
    public const string BaseModifierEvidenceRelationshipDuplicate = "baseModifierEvidence.relationship.duplicate";
    public const string BaseModifierEvidenceWeightNegative = "baseModifierEvidence.weight.negative";
    public const string BaseModifierEvidenceGenerationBucketRequired = "baseModifierEvidence.generationBucket.required";
    ...
    public const string UniqueCatalogOptionAxisInvalid = "uniqueItems.optionAxis.invalid";
    ...
    public const string UniqueFoulbornSourceInvalid = "uniqueItems.foulborn.source.invalid";
    public const string UniqueFoulbornRelationshipInvalid = "uniqueItems.foulborn.relationship.invalid";
    public const string UniqueFoulbornRelationshipDuplicate = "uniqueItems.foulborn.relationship.duplicate";
    public const string UniqueFoulbornRelationshipConflict = "uniqueItems.foulborn.relationship.conflict";
