...
public static class GameDataPackageJson
{
    ...
    private static JsonSerializerOptions CreateOptions()
    {
        ...
        options.Converters.Add(new JsonStringEnumConverter<ModifierSourceAvailability>(
            JsonNamingPolicy.CamelCase,
            allowIntegerValues: false));
        options.Converters.Add(new JsonStringEnumConverter<BaseModifierEvidenceSemantics>(
            JsonNamingPolicy.CamelCase,
            allowIntegerValues: false));
        options.Converters.Add(new JsonStringEnumConverter<BaseModifierEvidenceCoverage>(
            JsonNamingPolicy.CamelCase,
            allowIntegerValues: false));
        ...
        options.Converters.Add(new JsonStringEnumConverter<BaseImplicitSnapshotRole>(
            JsonNamingPolicy.CamelCase,
            allowIntegerValues: false));
        options.Converters.Add(new JsonStringEnumConverter<StatTranslationSnapshotRole>(
            JsonNamingPolicy.CamelCase,
            allowIntegerValues: false));
        options.Converters.Add(new JsonStringEnumConverter<StatTranslationCompatibilityClassification>(
            JsonNamingPolicy.CamelCase,
            allowIntegerValues: false));
        ...
        options.Converters.Add(new JsonStringEnumConverter<UniqueModifierBlockKind>(
            JsonNamingPolicy.CamelCase,
            allowIntegerValues: false));
        options.Converters.Add(new JsonStringEnumConverter<UniqueModifierSourceSemantics>(
            JsonNamingPolicy.CamelCase,
            allowIntegerValues: false));
        ...
        options.Converters.Add(new JsonStringEnumConverter<UniqueModifierSemanticLocality>(
            JsonNamingPolicy.CamelCase,
            allowIntegerValues: false));
        options.Converters.Add(new JsonStringEnumConverter<UniqueModifierSemanticValueShape>(
            JsonNamingPolicy.CamelCase,
            allowIntegerValues: false));
        options.Converters.Add(new JsonStringEnumConverter<UniqueFoulbornModifierRelationshipStatus>(
            JsonNamingPolicy.CamelCase,
            allowIntegerValues: false));
