...
internal static class PathOfExileTradeFiltersDiagnosticCodes
{
    public const string MalformedJson = "POE_TRADE_FILTERS_MALFORMED_JSON";
    public const string MissingResultCollection = "POE_TRADE_FILTERS_MISSING_RESULT_COLLECTION";
    public const string MissingCategoryFilter = "POE_TRADE_FILTERS_MISSING_CATEGORY_FILTER";
    public const string MissingCategoryOptions = "POE_TRADE_FILTERS_MISSING_CATEGORY_OPTIONS";
